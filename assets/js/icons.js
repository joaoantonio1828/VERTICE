// ============================================================
// VÉRTICE — Ícones SVG (subset do Lucide)
// assets/js/icons.js
// ============================================================

const ICON_DEFAULTS = `fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"`;
...
const PATHS = {
  ...
  'zap':              `<bolt points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>`,
  ...
  'car':              `<path d="M19 17H5c-1.1 0-2-.9-2-2V9c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2v6c0 1.1-.9 2-2 2"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="16.5" cy="17.5" r="2.5"/><path d="m3 9 2.45-4.9A2 2 0 0 1 7.24 3h9.52a2 2 0 0 1 1.8 1.1L21 9"/>`,
  ...
  'paw':              `<circle cx="11" cy="4" r="2"/><circle cx="18" cy="8" r="2"/><circle cx="20" cy="16" r="2"/><path d="M9 10a5 5 0 0 1 5 5v3.5a3.5 3.5 0 0 1-6.84 1.045Q6.52 17.48 4.46 16.84A3.5 3.5 0 0 1 5.5 10Z"/><circle cx="4" cy="8" r="2"/>`,
};

/**
 * Retorna o SVG de um ícone como string HTML
 * @param {string} name - Nome do ícone
 * @param {number} size - Tamanho em px (padrão 20)
 * @param {string} cls  - Classes adicionais
 */
export function icon(name, size = 20, cls = '') {
  const path = PATHS[name] || PATHS['more-horizontal'];
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" ${ICON_DEFAULTS} class="${cls}">${path}</svg>`;
}

/**
 * Injetar ícone num elemento
 */
